...
export default {
   ...
   methods: {
      copay_quote_result() {
         this.$refs.copay_quote_form.validate();
         if ( Object.values(this.$refs.copay_quote_form.errorBag).includes(true) ) {
            return this.$vuetify.goTo(this.$refs.copay_quote_form);
         }
